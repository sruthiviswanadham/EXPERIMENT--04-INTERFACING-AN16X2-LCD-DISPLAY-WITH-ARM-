...
int main(void)
{
  ...
  Lcd_cursor(&lcd,0,4);
  Lcd_string(&lcd,"DEPT- CYBER");
  Lcd_cursor(&lcd,1,4);
  Lcd_string(&lcd,"SRUTHI V");
  while (1)
  {
    /* USER CODE END WHILE */
...
## Output screen shots of proteus  :
 ![WhatsApp Image 2025-04-25 at 09 23 15_68a81afe](https://github.com/user-attachments/assets/4a5729f0-c61c-4afb-8989-e2a605e4d2b6)

 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
![WhatsApp Image 2025-04-25 at 09 30 41_8193c9e1](https://github.com/user-attachments/assets/6541ac83-6b9a-4dc2-93ce-4755015f8aec)
